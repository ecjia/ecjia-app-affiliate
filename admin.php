...
// 		RC_Style::enqueue_style('bootstrap-editable-css', RC_Uri::admin_url('statics/lib/x-editable/bootstrap-editable/css/bootstrap-editable.css'));
	...
	public function add() {
		...
		if (count($config['item']) >= 5) {
			$this->showmessage(RC_Lang::get('affiliate::affiliate.level_error'), ecjia::MSGTYPE_HTML | ecjia::MSGSTAT_ERROR);
...
// 			}
	...
	public function update() {
		...
		$this->showmessage(RC_Lang::get('affiliate::affiliate.edit_success'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('affiliate/admin/init')));
	}
